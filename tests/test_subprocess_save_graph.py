...
class SubprocessSaveGraphTests(unittest.TestCase):
    @patch("src.subprocess_pipeline_runner.subprocess.run")
    def test_run_stage2_subprocess_appends_save_graph_flag(self, subprocess_run_mock):
        ...
        self.assertIn("--save_graph", command)
