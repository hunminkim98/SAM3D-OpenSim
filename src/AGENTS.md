...
## Purpose
This directory contains the core pipeline modules. It wraps SAM3D Body inference, post-processes MHR70 keypoints, transforms coordinates into the OpenSim frame, converts keypoints into marker trajectories, writes TRC files, estimates MoGe-based scene ground, builds runtime OpenSim marker/task specs, and provides reusable inverse kinematics plus post-IK correction helpers.
